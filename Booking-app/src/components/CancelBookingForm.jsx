...
import { cancelBooking, getBookingsById } from "../services/bookingService";
...
function CancelBookingForm() {
  ...
  return (
    <div className="card mx-auto my-4" style={{ maxWidth: "500px" }}>
      <h2 className="card-header bg-primary text-white text-center">
        Cancel Slot
      </h2>
          ...
          <>
            <div className="card mb-3">
              <div className="card-body">
                ...
                <p
                  className={`card-text ${
                    bookingDetails.booked ? "text-success" : "text-danger"
                  }`}
                >
